...
public static partial class Regexes
{
    ...
    [GeneratedRegex(
        "^Mods/([^/]+)/Story/story_orphanqueries_ignore_local\\.txt$",
    ...
    [GeneratedRegex(
        "^Mods/([^/]+)/Story/RawFiles/TypeCoercionWhitelist\\.txt$",
        RegexOptions.IgnoreCase | RegexOptions.Compiled | RegexOptions.CultureInvariant)]
    ...
    [GeneratedRegex(
        "^Mods/([^/]+)/Levels/.*/(Characters|Items|Triggers)/.*\\.lsf$",
        RegexOptions.IgnoreCase | RegexOptions.Compiled | RegexOptions.CultureInvariant)]
